...
import com.example.xpense.ui.add_edit_expense.AddEditTransaction
import com.example.xpense.ui.home.Dashboard
import com.example.xpense.ui.expense_details.TransactionDetails
import com.example.xpense.ui.expense.Transactions
...
fun BottomBar(navController: NavHostController) {
    ...
    BottomNavigation(
        backgroundColor = Color(0xFF6D6A6B)
        ...
        BottomNavigationItem(
            icon =
            {
                Icon(
                    ...
                    contentDescription = stringResource(com.example.xpense.R.string.Home),
                )
            },
            label = {
                Text(text = "Dashboard")
